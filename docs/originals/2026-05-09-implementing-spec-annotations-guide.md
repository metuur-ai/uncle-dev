# Implementing `@spec` Annotations for Product Behavior

This guide explains how to use `@spec` annotations to connect durable product behavior to specs, tests, and code.
