...
It vendors the rule set from the MIT-licensed https://github.com/hvpandya skill by Hardik Pandya. The catalogs live in `references/`; this SKILL.md is the process that applies them.
