...
Source: stop-slop/references/structures.md. Unmodified except this attribution header.
Loaded by uncle-dev-speech Step 3 when a sentence SHAPE is the problem, not a single word.
-->
