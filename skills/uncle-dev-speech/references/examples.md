<!--
Vendored from the MIT-licensed `stop-slop` skill by Hardik Pandya (https://hvpandya.com).
Source: stop-slop/references/examples.md. Attribution header added; Example 4's
"After" corrected from an em dash to a period to comply with this skill's no-em-dash rule.
Loaded by uncle-dev-speech Step 3 to calibrate how aggressive a rewrite should be.
-->
